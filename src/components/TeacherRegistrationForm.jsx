  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
        <div>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input
              ...
              placeholder="Enter full name (e.g. Prof. Sarah Jenkins)"
              value={formData.name}
        ...
        <div>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input
              ...
              name="email"
              className="form-input"
              placeholder="Enter email address (e.g. teacher@example.com)"
        ...
        <div>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input
              ...
              name="password"
              className="form-input"
              placeholder={mode === 'admin' ? 'Enter password (leave blank for TempPass123!)' : 'Enter password (minimum 6 characters)'}
        ...
        <div>
          <label className="form-label">Teaching Department / Bio (Optional)</label>
          <textarea
            name="bio"
            className="form-input"
            rows="2"
            placeholder="Enter department or teaching bio (e.g. Department of Computer Science)..."
            value={formData.bio}
            onChange={handleChange}
